...
Revision ID: 7b2e7e9122e9
Revises: 
Create Date: 2020-06-30 21:47:34.006130
...
def upgrade():
    ...
    sa.Column('social_media', sqlalchemy_utils.types.json.JSONType(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('association_org',
    ...
    sa.Column('media_type', sa.Enum('audiovisual', 'blog', 'podcast', 'repositório', name='mediatype'), server_default='audiovisual', nullable=False),
    sa.Column('course_type', sa.Enum('online', 'presencial', name='coursetype'), server_default='online', nullable=True),
    sa.ForeignKeyConstraint(['org'], ['organization.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_project_id'), 'project', ['id'], unique=False)
    op.create_index(op.f('ix_project_name'), 'project', ['name'], unique=False)
    op.create_table('association_label',
